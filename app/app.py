...
class App(QtWidgets.QWidget):
    ...
    def setup_connections(self):     
        ...
        self.btn_inverser.clicked.connect(self.inverser_devise) # type: ignore
    ...
    def inverser_devise(self):
        ...
        devise_from = self.cbb_devisesFrom.currentText() # type: ignore
        devise_to = self.cbb_devisesTo.currentText() # type: ignore
        
        self.cbb_devisesFrom.setCurrentText(devise_to) # type: ignore
        self.cbb_devisesTo.setCurrentText(devise_from) # type: ignore
